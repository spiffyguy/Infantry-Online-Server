...
namespace Infantry_Launcher.Protocol
{
    public class AssetDownloader
    {
        ...
        public void DownloadAssetList(string assetName)
        {
            ...
            System.Net.ServicePointManager.SecurityProtocol = (SecurityProtocolType)192; // 0 = SystemDefault - See: https://learn.microsoft.com/en-us/dotnet/api/system.net.securityprotocoltype?view=net-7.0
